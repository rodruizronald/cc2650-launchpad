...
override PKGDIR = xconfig_pin_dht11
...
package/%.xdc.inc package/%_xconfig_pin_dht11.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_pin_dht11" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em3 .dlls: pin_dht11.pem3

-include package/cfg/pin_dht11_pem3.mak
-include package/cfg/pin_dht11_pem3.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/pin_dht11_pem3.dep
endif
pin_dht11.pem3: package/cfg/pin_dht11_pem3.xdl
	@


ifeq (,$(wildcard .libraries,em3))
pin_dht11.pem3 package/cfg/pin_dht11_pem3.c: .libraries,em3
endif

package/cfg/pin_dht11_pem3.c package/cfg/pin_dht11_pem3.h package/cfg/pin_dht11_pem3.xdl: override _PROG_NAME := pin_dht11.xem3
package/cfg/pin_dht11_pem3.c: package/cfg/pin_dht11_pem3.cfg
package/cfg/pin_dht11_pem3.xdc.inc: package/cfg/pin_dht11_pem3.xdl
package/cfg/pin_dht11_pem3.xdl package/cfg/pin_dht11_pem3.c: .interfaces

clean:: clean,em3
	-$(RM) package/cfg/pin_dht11_pem3.cfg
	-$(RM) package/cfg/pin_dht11_pem3.dep
	-$(RM) package/cfg/pin_dht11_pem3.c
	-$(RM) package/cfg/pin_dht11_pem3.xdc.inc

clean,em3::
	-$(RM) pin_dht11.pem3
.executables,em3 .executables: pin_dht11.xem3

pin_dht11.xem3: |pin_dht11.pem3

-include package/cfg/pin_dht11.xem3.mak
pin_dht11.xem3: package/cfg/pin_dht11_pem3.oem3 
	$(RM) $@
	@$(MSG) lnkem3 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M3.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M3 -z --strict_compatibility=on  -o $@ package/cfg/pin_dht11_pem3.oem3   package/cfg/pin_dht11_pem3.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M3.rootDir)/lib/libc.a
	
pin_dht11.xem3: export C_DIR=
pin_dht11.xem3: PATH:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)
pin_dht11.xem3: Path:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)

pin_dht11.test test,em3 test: pin_dht11.xem3.test

pin_dht11.xem3.test:: pin_dht11.xem3
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 pin_dht11.xem3.test
else
	@$(MSG) running $<  ...
	$(call EXEC.pin_dht11.xem3, ) 
endif

clean,em3::
	-$(RM) $(wildcard .tmp,pin_dht11.xem3,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
pin_dht11_pem3.oem3,copy : package/cfg/pin_dht11_pem3.oem3
pin_dht11_pem3.sem3,copy : package/cfg/pin_dht11_pem3.sem3

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_pin_dht11
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_pin_dht11.tar.dep
endif
package/rel/xconfig_pin_dht11/xconfig_pin_dht11/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_pin_dht11/xconfig_pin_dht11/package/package.rel.xml: package/build.cfg
package/rel/xconfig_pin_dht11/xconfig_pin_dht11/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_pin_dht11/xconfig_pin_dht11/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_pin_dht11.tar: package/rel/xconfig_pin_dht11.xdc.inc package/rel/xconfig_pin_dht11/xconfig_pin_dht11/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_pin_dht11.xdc.inc,package/rel/xconfig_pin_dht11.tar.dep)


release release,xconfig_pin_dht11: all xconfig_pin_dht11.tar
clean:: .clean
	-$(RM) xconfig_pin_dht11.tar
	-$(RM) package/rel/xconfig_pin_dht11.xdc.inc
	-$(RM) package/rel/xconfig_pin_dht11.tar.dep
