...
.dlls,em3 .dlls: dht11.pem3

-include package/cfg/dht11_pem3.mak
-include package/cfg/dht11_pem3.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/dht11_pem3.dep
endif
dht11.pem3: package/cfg/dht11_pem3.xdl
	@


ifeq (,$(wildcard .libraries,em3))
dht11.pem3 package/cfg/dht11_pem3.c: .libraries,em3
endif

package/cfg/dht11_pem3.c package/cfg/dht11_pem3.h package/cfg/dht11_pem3.xdl: override _PROG_NAME := dht11.xem3
package/cfg/dht11_pem3.c: package/cfg/dht11_pem3.cfg
package/cfg/dht11_pem3.xdc.inc: package/cfg/dht11_pem3.xdl
package/cfg/dht11_pem3.xdl package/cfg/dht11_pem3.c: .interfaces

clean:: clean,em3
	-$(RM) package/cfg/dht11_pem3.cfg
	-$(RM) package/cfg/dht11_pem3.dep
	-$(RM) package/cfg/dht11_pem3.c
	-$(RM) package/cfg/dht11_pem3.xdc.inc

clean,em3::
	-$(RM) dht11.pem3
.executables,em3 .executables: dht11.xem3

dht11.xem3: |dht11.pem3

-include package/cfg/dht11.xem3.mak
dht11.xem3: package/cfg/dht11_pem3.oem3 
	$(RM) $@
	@$(MSG) lnkem3 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M3.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M3 -z --strict_compatibility=on  -o $@ package/cfg/dht11_pem3.oem3   package/cfg/dht11_pem3.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M3.rootDir)/lib/libc.a
	
dht11.xem3: export C_DIR=
dht11.xem3: PATH:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)
dht11.xem3: Path:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)

dht11.test test,em3 test: dht11.xem3.test

dht11.xem3.test:: dht11.xem3
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 dht11.xem3.test
else
	@$(MSG) running $<  ...
	$(call EXEC.dht11.xem3, ) 
endif

clean,em3::
	-$(RM) $(wildcard .tmp,dht11.xem3,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
dht11_pem3.oem3,copy : package/cfg/dht11_pem3.oem3
dht11_pem3.sem3,copy : package/cfg/dht11_pem3.sem3
